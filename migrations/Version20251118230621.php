 ...
 */
final class Version20251118230621 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE queue_job (id SERIAL NOT NULL, type VARCHAR(100) NOT NULL, payload JSON NOT NULL, status VARCHAR(20) NOT NULL, processed_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, error_message TEXT DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX idx_status_id ON queue_job (status, id)');
        $this->addSql('COMMENT ON COLUMN queue_job.processed_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('COMMENT ON COLUMN queue_job.created_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('COMMENT ON COLUMN queue_job.updated_at IS \'(DC2Type:datetime_immutable)\'');
