...
final class StepsGeneratePrompt implements PromptInterface
{
    ...
    {
        if (!$context instanceof StepsGenerateContext) {
            throw new \InvalidArgumentException(
                sprintf('["%s"] needs an instance of "%s". Received: "%s".', self::class, StepsGenerateContext::class, get_class($context))
            );
        }
